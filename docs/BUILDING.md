...
This guide helps you build MeetingOne on Linux with **automatic GPU acceleration**. The build system detects your hardware and configures the best performance automatically.
...
```
src-tauri/target/release/bundle/appimage/MeetingOne_<version>_amd64.AppImage
```
