...
- Artifacts prefixed with `meetingone-test-`
...
```
meetingone-{workflow}-{platform}-{target}-{version}
```

**Examples:**
- `meetingone-devtest-macOS-aarch64-apple-darwin-0.1.3`
- `meetingone-test-windows-x86_64-pc-windows-msvc-0.1.3`
- `meetingone-macos-aarch64-release-0.1.3`
...
- `MEETINGONE_RSA_PUBLIC_KEY` - License validation public key
