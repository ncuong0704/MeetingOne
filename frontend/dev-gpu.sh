#!/bin/bash
# GPU-accelerated development script for MeetingOne
...
echo -e "${BLUE}🚀 MeetingOne GPU-Accelerated Development Mode${NC}"
echo ""
...
echo ""
echo -e "${BLUE}📦 Starting MeetingOne in development mode...${NC}"
echo ""
