...
export const TranscriptView: React.FC<TranscriptViewProps> = ({ transcripts, isRecording = false, isPaused = false, isProcessing = false, isStopping = false, enableStreaming = false }) => {
  ...
  return (
    <div className="px-4 py-2">
      ...
      <AnimatePresence>
        {isRecording && (
          <div className="sticky top-4 z-10 bg-paper pb-2">
        ...
        return (
          ...
          >
            <div className="flex items-start gap-2">
              <Tooltip>
                <TooltipTrigger>
                  <span className="text-xs text-ink-2 mt-1 flex-shrink-0 min-w-[50px]">
              ...
              <div className="flex-1">
                {isStreaming ? (
                  ...
                  <div className="bg-paper-3 border border-rule rounded-md px-3 py-2">
