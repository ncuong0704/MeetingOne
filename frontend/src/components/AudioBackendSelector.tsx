    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-ink text-paper-2 rounded-md">
          ...
          return (
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-primary focus-visible:ring-ring border-gray-300"
              />
