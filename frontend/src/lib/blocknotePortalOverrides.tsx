...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(
      'bn-relative bn-flex bn-w-auto bn-cursor-default bn-select-none bn-items-center bn-whitespace-nowrap bn-rounded-sm bn-px-2 bn-py-1.5 bn-text-sm bn-outline-none bn-transition-colors focus:bn-bg-accent focus:bn-text-accent-foreground data-[disabled]:bn-pointer-events-none data-[disabled]:bn-opacity-50',
      inset && 'bn-pl-8',
      className,
    )}
    {...props}
...
/** Portal + width:auto so drag-handle menus are not clipped in scroll areas. */
export const blocknoteShadcnPortalOverrides = {
  DropdownMenu: {
    DropdownMenu,
