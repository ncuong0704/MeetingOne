# GPU-accelerated development script for MeetingOne (Windows PowerShell)
# Automatically detects and runs in development mode with optimal GPU features

Write-Host "GPU-Accelerated Development Mode for MeetingOne" -ForegroundColor Blue
Write-Host ""
...
Write-Host ""
Write-Host "Starting MeetingOne in development mode..." -ForegroundColor Blue
Write-Host ""
